...
contract OpenOracleGGFeaturesTest is BaseGGTest {
    ...
    function testInitialReport_FundedByInternalBalance() public {
        ...
        vm.prank(bob);
        _submitInitialReport(reportId, 1e18, 2000e18, sh, true, true, _emptyTiming());
    ...
    function testApproveInternal_InfiniteAllowance_NotDecremented() public {
        ...
        vm.prank(alice);
        _submitInitialReport(reportId, 1e18, 2000e18, sh, bob, true, true, _emptyTiming());
    ...
    function testInitialReport_FallbackWhenAllowanceInsufficient() public {
        ...
        _submitInitialReport(reportId, 1e18, 2000e18, sh, bob, true, false, _emptyTiming());
    ...
    function testDust_InternalSpendCannotGoBelowSentinel() public {
        ...
        vm.prank(bob);
        _submitInitialReport(reportId, 1e18, 2000e18, sh, true, false, _emptyTiming());
